...
/* ====================================================================== */
/**
 * @brief 左下が直角の二等辺三角形を表す実装クラス
 *
 * @note このクラスは抽象クラスAbstIsosRightTriangleから派生したクラス
 * 具体的な左下直角の二等辺三角形インスタンスは、このクラスで生成する
 * @see Shape
 * @see AbstIsosRightTriangle
 */
/* ====================================================================== */
public class DownLeftTri extends AbstIsosRightTriangle {
